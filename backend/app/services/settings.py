...
def public_shop_settings(db: Session) -> dict:
    ...
    return {
        ...
        "card_transfer_enabled": bool(all_s.get("card_transfer_enabled", True)),
        "card_number": str(all_s.get("card_number") or ""),
        "card_holder": str(all_s.get("card_holder") or ""),
        "card_bank_name": str(all_s.get("card_bank_name") or ""),
        "card_transfer_instructions": str(all_s.get("card_transfer_instructions") or ""),
